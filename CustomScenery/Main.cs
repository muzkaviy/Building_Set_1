...
namespace Custom_Scenery
{
    public class Main : IMod
    {
        ...
        public string Name { get { return "shyguy's Building Set 1"; } }
        public string Description { get { return "Basic building set containing walls, doors, windows, roofs, and floors."; } }
